...
function Privacy() {
  return (
    <Box>
      <Head>
        <title>Terms & Conditions - ZedPay</title>
      ...
      <Container maxW={"6xl"} my={10}>
        <Box>
          <Stack as={Container} maxW={"6xl"} mt={10}>
            ...
            <Text my={10}>
              Welcome to ZedPay These terms and conditions outline the rules
              and regulations for the use of ZedPay&apos; s Website,
              located at https://zenithpay.network. By accessing this website we
          ...
          <Text p={4}>
            We employ the use of cookies. By accessing ZedPay, you agreed to
            use cookies in agreement with the ZedPay&apos; s Privacy Policy. Most
          ...
          <Text p={4}>
            Unless otherwise stated, ZedPay and/or its licensors own the
            intellectual property rights for all material on ZedPay. All
            intellectual property rights are reserved. You may access this from
            ZedPay for your own personal use subjected to restrictions set in
          ...
          <List spacing={3} textAlign="start" p={4}>
            <ListItem>
              ...
              Republish material from ZedPay
            </ListItem>
            <ListItem>
              <ListIcon as={FaCheckCircle} color="yellow.500" />
              Sell, rent or sub-license material from ZedPay
            </ListItem>

            <ListItem>
              <ListIcon as={FaCheckCircle} color="yellow.500" />
              Reproduce, duplicate or copy material from ZedPay
            </ListItem>

            <ListItem>
              <ListIcon as={FaCheckCircle} color="yellow.500" />
              Redistribute content from ZedPay
            </ListItem>
          </List>
        </Box>
      </Container>
